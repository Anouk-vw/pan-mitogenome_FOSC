...
if args.plot:
    ...
    #29-05-2024 -> remove '#' from split to read full name in plot
    #name_list = [x.split(' ')[-1].split('#')[-1] for x in id_2_name_dict.values()]
    name_list = [x.split(' ')[-1] for x in id_2_name_dict.values()]
    ...
    ig.plot(
        partition,
        target = f'{output_prefix}.communities.png',
        vertex_size=50,
...
if args.plot:
    ...
    ig.plot(
        partition,
        target = f'{output_prefix}sparse.communities.png',
        vertex_size=50,
        #vertex_color=['blue', 'red', 'green', 'yellow'],
        vertex_label=name_list,
        vertex_label_size=20,
...
if args.plot:
    ...
    ig.plot(
        partition,
        target = f'{output_prefix}sparse.communities.pdf',
        vertex_size=50,
        #vertex_color=['blue', 'red', 'green', 'yellow'],
        vertex_label=name_list,
        vertex_label_size=20,
